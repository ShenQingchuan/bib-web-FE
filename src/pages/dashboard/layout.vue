<template>
  <a-layout class="page-dashboard__container">
    <a-layout-header class="page-dashboard__header"><common-header /></a-layout-header>
    <a-layout>
      <a-layout-sider class="page-dashboard__side-navigator flex-col p-tb-24 p-lr-8" width="256px">
        <side-navigator-item link="/dashboard" label="工作台">
          <template #icon> <LaptopOutlined class="m-r-8" /> </template>
        </side-navigator-item>
        <side-navigator-item link="/dashboard/collections" label="收藏" >
          <template #icon> <StarOutlined class="m-r-8" /> </template>
        </side-navigator-item>
        <side-navigator-item link="/dashboard/recycles" label="回收站" >
          <template #icon> <DeleteOutlined class="m-r-8" /> </template>
        </side-navigator-item>
      </a-layout-sider>
