    ...
    <template #center>
      ...
      >
        ...
        <a-form-item name="userEmail" hasFeedback>
          <a-input v-model:value="registerForm.userEmail" placeholder="请输入邮箱地址">
            <template #prefix>
              <MailOutlined />
            </template>
          </a-input>
        ...
        <a-form-item name="userPhone" hasFeedback>
          <a-input v-model:value="registerForm.userPhone" placeholder="请输入手机号码（仅支持中国大陆）">
            <template #prefix>
              <PhoneOutlined />
            </template>
          </a-input>
        ...
        <a-form-item name="phoneVerify">
          <div class="flex-row anis-center">
            <a-input v-model:value="registerForm.phoneVerify" placeholder="请输入短信验证码">
              <template #prefix>
                <KeyOutlined />
              </template>
            </a-input>
            <a-button class="m-l-8" :disabled="isSendSmsCodeBtnDisabled" @click="sendSmsCode">
              {{
        ...
        <a-form-item name="password" hasFeedback>
          <a-input v-model:value="registerForm.password" placeholder="请输入密码" type="password">
            <template #prefix>
              <LockOutlined />
            </template>
          </a-input>
